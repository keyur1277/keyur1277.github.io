...
Both [[क]] [[प]]  achieve [[य]]. Both set of limbs could be used for both functions when language emerged. Later it got specialized and क got more and more associated with hands and प with legs. But at time of emergence of धातु पाठ and teaching of very initial सुत्र - the use was not exclusive. [[3.1.13]] refers to manipulative use of leg fingures while referring to leg as क and leg fingers as क्यष्. Though what the sutra instructs can be done by Sapiense anatomy also, in sapiens context it would have been called प्यष् and not क्यष्. So either it was possible to use legs for manipulative use or language had रूढ memory of that use 